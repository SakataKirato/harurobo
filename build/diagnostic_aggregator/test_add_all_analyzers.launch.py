...
def generate_test_description():
    ...
    aggregator_node = ExecuteProcess(
        cmd=[
            "/home/a/harurobo/install/diagnostic_aggregator/lib/diagnostic_aggregator/aggregator_node",
            "--ros-args",
            "--params-file",
            "/home/a/harurobo/src/diagnostics/diagnostic_aggregator/test/default.yaml"
            ],
    ...
    add_analyzer = ExecuteProcess(
        cmd=[
            "/home/a/harurobo/install/diagnostic_aggregator/lib/diagnostic_aggregator/add_analyzer",
            "--ros-args",
            "--params-file",
            "/home/a/harurobo/src/diagnostics/diagnostic_aggregator/test/all_analyzers.yaml"
            ],
        name='add_analyzer',
        emulate_tty=True,
        output='screen')
...
class TestAggregator(unittest.TestCase):
    ...
    def test_processes_output(self, proc_output, aggregator_node):
        ...
        proc_output.assertWaitFor(
            expected_output=launch_testing.tools.expected_output_from_file(path="/home/a/harurobo/src/diagnostics/diagnostic_aggregator/test/expected_output/add_all_analyzers"),
